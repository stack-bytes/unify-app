...
export const EventBillboard = ({setFocusedMarkerIndex}) => {
    return (
        <View className="relative w-[90vw] h-[200px] border-2 border-[#121212]/[0.3]  rounded-md">
                ...
                <Image className="w-full h-[75%] rounded-t-md" source={{uri:  "https://imgs.search.brave.com/8kGu884s4LEEEGG8fdg0GUhcEAsIFbXE6bzj1HSdnB0/rs:fit:860:0:0/g:ce/aHR0cHM6Ly9jb250/ZW50LmZvcnR1bmUu/Y29tL3dwLWNvbnRl/bnQvdXBsb2Fkcy8y/MDIzLzExL0FQMjMz/MTI3MjYyNTU3MjIt/ZTE2OTk0NzczMTI3/NDguanBnP3c9MTQ0/MCZxPTc1"}}/>
